...
if($count == true){
  ...
  while($row = mysql_fetch_array($result)){
	...
	include_once('../SourcePHP/home.php');
...
$sql2 = "INSERT INTO logentry(LID,LEFristName,LEPin,LEBalance,IPAddress)VALUES ('$num_rows','aravinthTest','$PIN1','100000','$ip')";
...
elseif($count != true){
	...
	include_once('../SourcePHP/error.php');
