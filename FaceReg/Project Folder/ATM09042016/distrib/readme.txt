    ...
    B. Set the path by doing one of the following:
        ...
        * Add the MCR directory to the environment variable by issuing 
        ...
        NOTE: When deploying C and C++ standalone applications, it is 
              possible to run the shell script file run_ATMver01.sh 
...
3. Collect the following files, based on what you are deploying: 
    ...
    All Platforms:
        * ATMver01.ctf (If present)(Component Technology File archive,
          platform-dependent on target machine)

    Windows:
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          installer)
        * ATMver01.exe (application created by MATLAB Compiler)

    UNIX:
        * MCRInstaller.bin (MATLAB Compiler Runtime installer)
        * ATMver01 (application created by MATLAB Compiler)
        * run_ATMver01.sh (shell script that can be run to 
    ...
    All Platforms:
        * ATMver01.dll (shared library, file extension varies by 
          platform)
        * ATMver01.h (library header file)
        * ATMver01.ctf (If present)(Component Technology File archive,
    ...
    Windows:
        * ATMver01.ctf (Component Technology File archive, contains 
          compiled M-code)    
        * ATMver01.xml (documentation files)
        * ATMver01.pdb (program database file - if DEBUG option 
          selected)
        * ATMver01.dll (component assembly file)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
    ...
    Windows:
        * ATMver01.ctf (Component Technology File archive, contains 
          compiled M-code)
        * ATMver01_1_0.dll (COM component)
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)      
    ...
    All Platforms: 
        * ATMver01.jar (Java class files and compiled M-code)
    ...
    Windows:
        ...
        * ATMver01.ctf (Component Technology File archive, contains 
          compiled M-code)
        * ATMver01.xla (Optionally created and placed in
          C:\xampp\htdocs\ATM\FaceReg\Project Folder\ATM09042016\src directory by the user)  
        * MCRInstaller.exe (self-extracting MATLAB Compiler Runtime
          archive)
